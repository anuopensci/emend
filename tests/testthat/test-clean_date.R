test_that("date cleaning works", {
  ...
  input_1 <- c("16/02/1997", "24 Mar 2022", "2000-01-01", "Jason", "Dec 25, 2030", "12/05/2024")
  truth_1 <- as.Date(c("1997-02-16", "2022-03-24", "2000-01-01", "Jason", "2030-12-25", "2024-05-12"), format = "%Y-%m-%d")
